...
https://docs.microsoft.com/en-us/azure/azure-sql/database/high-cpu-diagnose-troubleshoot?view=azuresql
...
SET @query_hash = 0x190845931EDA14A6;
...
--to determine which query uses the most cumulative CPU.
SELECT
