...
select count(*) from tbl_distributor_commissions_v2 --136349846
exec sp_spaceused tbl_distributor_commissions_v2 
-- Reserverd: 294.104.904 KB
-- Index_size: 114.140.928 KB

--ALTER INDEX [Ix_Nn_tbl_distributor_commissions_v2_MARKETID_CommPeriodId_TOTAL_COMMISSIONS_VALUE] 
--ON [dbo].[tbl_distributor_commissions_v2] REBUILD PARTITION = ALL WITH (STATISTICS_NORECOMPUTE = OFF
--, ONLINE = OFF, DATA_COMPRESSION = PAGE)
...
/*
CHEQUEO DE BENEFICIO DE COMPRESION EN LAS TABLAS:
