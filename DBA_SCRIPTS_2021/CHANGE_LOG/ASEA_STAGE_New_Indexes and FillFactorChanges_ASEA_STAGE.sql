...
--WITH --(ONLINE=ON,DATA_COMPRESSION=PAGE); -- 13m cancelled. 13 minutes, cancelled. EXECUTION PLAN: HIGH COST INSERTING ON BASE TABLE!!!!!!!!!!!!!--(76%) -- may because hugh row size.ç
