...
--EXEC ##sp_WhoIsActive
    ...
    @delta_interval = 1,
    @output_column_list = '[dd%][session_id][sql_text][sql_command][block%][login_name][wait_info][tasks][tran_log%][cpu%][temp%][reads%][writes%][context%][physical%][query_plan][locks][%]',
